...
let letras="abcdefghijklmnñopqrstuvwxyz"; //Voy a contar letras necesito saber cuales son
...
function recodificar(letra) {
    let conAcento="áéíóú"; // lista de letras acentuadas en español
    let sinAcento="aeiou"; // lista de letras sin acento
    if (conAcento.indexOf(letra)>=0)
        return sinAcento.charAt(conAcento.indexOf(letra)); //Si encuentra la letra en acentuadas retorna la letra sin acentuar
    else
        return letra; // retorna la letra original
} 
